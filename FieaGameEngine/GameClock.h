...
namespace Fiea::GameEngine
{
	...
	*/
	...
	public:
		...
		*/
		inline Millis Get() const { return std::chrono::duration_cast<Millis>(_current.time_since_epoch()); };
		/**
		 * @brief Milliseconds since start
		 * @return milliseconds since start
		*/
		inline Millis Game() const { return std::chrono::duration_cast<Millis>(_current - _start); };
		/**
		 * @brief Milliseconds since last frame
		 * @return milliseconds since last frame
		*/
		inline Millis Frame() const { return std::chrono::duration_cast<Millis>(_current - _last); };
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		 * @brief Returns game time with simulated elapsed time
		 * @param ms The amount of time elapsed
		*/
		static GameTime CreateElapsedTime(int ms);
